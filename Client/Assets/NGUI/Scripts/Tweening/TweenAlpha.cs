...
public class TweenAlpha : UITweener
{
    ...
    //扩展
    static public TweenAlpha Begin(GameObject go, float duration, float alpha, float startDelay)
    {
        TweenAlpha comp = UITweener.Begin<TweenAlpha>(go, duration, startDelay);
        comp.from = comp.value;
        comp.to = alpha;
